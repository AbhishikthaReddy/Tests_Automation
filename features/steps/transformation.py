	...
	def scenario_writing_to_files(self, resultsfilelocation, datafiles_names, deffiles_names, control_def_file_loc,date,timestamp):
		...
		for i in range(0, len(datafiles_names)):
			...
			if len(dupff)>0:
				...
				line8 = {"Test name": "Duplicate values", "Result":"Failed","Output":result_dup_list}
			else:
				line8={"Test name":"Duplicate values", "Result":"Passed"}


			# copying the file to passed or fail folder

			if line1["Result"] == "Passed" and line2["Result"] == "Passed" and line3["Result"] == "Passed" and line4["Result"] == "Passed" and line5["Result"] == "Passed" and line8["Result"]== "Passed":
			...
			final_lines_to_file = {"Test-1": line1, "Test-2": line2, "Test-3": line3, "Test-4": line4, "Test-5": line5,"Test-8":line8}
